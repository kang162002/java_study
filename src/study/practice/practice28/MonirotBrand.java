...
public class MonirotBrand {
	...
	MonirotBrand (String company, int inch, int price) { // 필드 변수에 넘겨서 저장해놔야 유지됨
	...
	void setColor (String color) {// 매개변수 안에있는 ( String name) < 일회용
		this.color = color;
		//입력 > 수행할 코드 > 출력
		//매개변수 > 코드> return
	}
	...
	void printInfo() {
		System.out.printf("%s %d인치 %s 모니터 가격:%d원 해상도:%d \n",
...
//		String color;			//	색상
//		
//		int maxResolutionX;		// 화질X
//		int maxResolutionY;		// 화질Y
